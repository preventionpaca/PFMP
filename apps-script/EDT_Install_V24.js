/** EDT V2.4 - Compléments installation compatibles avec ton socle Apps Script existant.
...
function EDT_installerStructure_V24() {
  EDT_installSchema_(EDT_SCHEMA_V24_ADDONS);
  EDT_installSchema_(EDT_SCHEMA_V24_COLUMNS);
  ...
  Logger.log('✅ Compléments EDT V2.4 installés.');
}
