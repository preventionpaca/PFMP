/** Eucalyptus PFMP — v1.0.0-dev.82 — pages administration référentiels Pronote et diplômes. */
function EUC_PC_afficherSynchronisation(){
  ...
  tpl.config=JSON.stringify({version:'Eucalyptus PFMP — v1.0.0-dev.82',role:ctx.role,baseUrl:ScriptApp.getService().getUrl()});
