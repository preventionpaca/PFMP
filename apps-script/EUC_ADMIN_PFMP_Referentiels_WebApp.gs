/** Eucalyptus PFMP — v1.0.0-dev.86 — pages administration référentiels Pronote, diplômes et paramètres convention. */
...
function EUC_PARAM_CONV_afficher(){
  ...
  tpl.config={version:'Eucalyptus PFMP — v1.0.0-dev.86',role:ctx.role,baseUrl:ScriptApp.getService().getUrl()};
