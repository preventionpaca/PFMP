/** Eucalyptus PFMP — v1.0.0-dev.87 — générateur et impressions calés sur le modèle Word utilisateur. */
function EUC_CONVENTION_afficherGenerateur(){
  ...
  var tpl=HtmlService.createTemplateFromFile('Convention_PFMP_Generateur');tpl.config=JSON.stringify({version:'Eucalyptus PFMP — v1.0.0-dev.87',baseUrl:ScriptApp.getService().getUrl()});
