/** Eucalyptus PFMP — v1.0.0-dev.105 — générateur PDF AcroForm 2 pages + conservation Word secondaire. */
function EUC_CONVENTION_afficherGenerateur(){
  ...
  var tpl=HtmlService.createTemplateFromFile('Convention_PFMP_Generateur');tpl.config=JSON.stringify({version:'Eucalyptus PFMP — v1.0.0-dev.105',baseUrl:ScriptApp.getService().getUrl()});
