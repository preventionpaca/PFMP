/** Lycée Les Eucalyptus — PFMP — v1.0.0-dev.122 — générateur conventions + filtre strict périodes. */
function EUC_CONVENTION_afficherGenerateur(){
  ...
  var tpl=HtmlService.createTemplateFromFile('Convention_PFMP_Generateur');tpl.config=JSON.stringify({version:'Lycée Les Eucalyptus — PFMP — v1.0.0-dev.122',baseUrl:ScriptApp.getService().getUrl()});
