/** Eucalyptus PFMP — v1.0.0-dev.79 — import fichier Pronote largeur fixe élèves + responsables. */
function EUC_IMPORT_afficherApplication(){
  ...
  tpl.config=JSON.stringify({version:'Eucalyptus PFMP — v1.0.0-dev.79',mode:'IMPORT_REEL_CONTROLE',role:ctx.role,baseUrl:ScriptApp.getService().getUrl()});
