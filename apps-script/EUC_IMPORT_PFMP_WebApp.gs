/** Eucalyptus PFMP — v1.0.0-dev.67 — route import Pronote protégée + feedback visuel + import inutile explicite. */
function EUC_IMPORT_afficherApplication(){
  ...
  tpl.config=JSON.stringify({version:'Eucalyptus PFMP — v1.0.0-dev.67',mode:'IMPORT_REEL_CONTROLE',role:ctx.role,baseUrl:ScriptApp.getService().getUrl()});
