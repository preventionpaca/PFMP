/** Eucalyptus PFMP — v1.0.0-dev.63 — route import Pronote protégée et séparée du formulaire élève. */
function EUC_IMPORT_afficherApplication(){
  ...
  tpl.config=JSON.stringify({version:'Eucalyptus PFMP — v1.0.0-dev.63',mode:'DRY_RUN',role:ctx.role,baseUrl:ScriptApp.getService().getUrl()});
